**2024-04-18: Switched from Pearson to Spearman correlation, removed lines of best fit, and plotted uniqueness with shared y-axis.**
...
DO.AL.v.B6.pathway.age.coef.cor <- cor(
  ...
  DO.AL.v.B6.pathway.maaslin.df$coef.B6, method="spearman")
