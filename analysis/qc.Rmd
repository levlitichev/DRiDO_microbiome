...
stool.meta.df <- read.table("../data/metadata/stool_metadata_after_mbmix_n3200_230620.txt", sep="\t", header=T)
...
#   write.table(
#     sprintf("../data/metadata/stool_metadata_after_QC_n%i_230620.txt", nrow(.)),
#     sep="\t", quote=F, row.names=F)
```
...
#   write.table(
#     sprintf("../data/metadata/stool_metadata_after_QC_no_controls_n%i_230620.txt", nrow(.)),
#     sep="\t", quote=F, row.names=F)
```
