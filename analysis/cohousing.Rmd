...
# Compute t-test statistics manually

## exCY, B v. C

```{r}
t.test(
  genus.bc.dist.to.uncohoused.df %>% dplyr::filter(dist.from == "exCY") %>% dplyr::filter(timepoint.short.x == "B") %>% pull(dist),
  genus.bc.dist.to.uncohoused.df %>% dplyr::filter(dist.from == "exCY") %>% dplyr::filter(timepoint.short.x == "C") %>% pull(dist))
```
...
t.test(
  genus.bc.dist.to.uncohoused.df %>% dplyr::filter(dist.from == "exCY") %>% dplyr::filter(timepoint.short.x == "B") %>% pull(dist),
  genus.bc.dist.to.uncohoused.df %>% dplyr::filter(dist.from == "exCY") %>% dplyr::filter(timepoint.short.x == "S2") %>% pull(dist))
```
...
t.test(
  genus.bc.dist.to.uncohoused.df %>% dplyr::filter(dist.from == "exCY") %>% dplyr::filter(timepoint.short.x == "B") %>% pull(dist),
  genus.bc.dist.to.uncohoused.df %>% dplyr::filter(dist.from == "exCY") %>% dplyr::filter(timepoint.short.x == "S4") %>% pull(dist))
```
...
t.test(
  genus.bc.dist.to.uncohoused.df %>% dplyr::filter(dist.from == "exCY") %>% dplyr::filter(timepoint.short.x == "B") %>% pull(dist),
  genus.bc.dist.to.uncohoused.df %>% dplyr::filter(dist.from == "exCY") %>% dplyr::filter(timepoint.short.x == "S6") %>% pull(dist))
```
...
t.test(
  genus.bc.dist.to.uncohoused.df %>% dplyr::filter(dist.from == "exCY") %>% dplyr::filter(timepoint.short.x == "B") %>% pull(dist),
  genus.bc.dist.to.uncohoused.df %>% dplyr::filter(dist.from == "exCY") %>% dplyr::filter(timepoint.short.x == "S8") %>% pull(dist))
```
...
```{r}
t.test(
  genus.uniq.bc.df %>% dplyr::filter(current.group == "Y") %>% pull(uniqueness),
  genus.uniq.bc.df %>% dplyr::filter(current.group == "O") %>% pull(uniqueness))
```

```{r}
t.test(
  genus.uniq.bc.df %>% dplyr::filter(current.group == "Y") %>% pull(uniqueness),
  genus.uniq.bc.df %>% dplyr::filter(current.group == "CY") %>% pull(uniqueness))
```

```{r}
t.test(
  genus.uniq.bc.df %>% dplyr::filter(current.group == "Y") %>% pull(uniqueness),
  genus.uniq.bc.df %>% dplyr::filter(current.group == "exCY") %>% pull(uniqueness))
```
